    ...
    <>
     ...
     <div className="card md:my-16 border-[1px]  my-10 hover:scale-105 hover:border-2 duration-300 card-compact bg-base-100 w-80 shadow-xl">
        ...
        <div className="card-body">
          <h2 className="card-title">{item.name} <button className="bg-pink-500 text-white text-[14px] rounded-full px-2 font-bold">new</button> </h2>
          <p>{item.title}</p>
          <div className="card-actions justify-between">
            <button className="px-3 py-1 rounded-full text-white bg-blue-600">${item.price}</button>
